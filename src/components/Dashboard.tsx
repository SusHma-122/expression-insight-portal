...
import { BarChart, Database, FileSearch, Box } from 'lucide-react';
...
const Dashboard = ({ selectedDataset }: DashboardProps) => {
  ...
  const mockTopGenes = [
    { symbol: 'BRCA1', logFC: 2.45, pValue: 0.001, adjPValue: 0.012 },
    { symbol: 'TP53', logFC: -1.89, pValue: 0.003, adjPValue: 0.024 },
    { symbol: 'ESR1', logFC: 3.21, pValue: 0.000, adjPValue: 0.008 },
    { symbol: 'HER2', logFC: 1.67, pValue: 0.007, adjPValue: 0.045 },
    { symbol: 'MYC', logFC: -2.14, pValue: 0.002, adjPValue: 0.018 },
    { symbol: 'PTEN', logFC: 1.92, pValue: 0.005, adjPValue: 0.032 }
  ];

  const mockClassifierResults = {
    accuracy: 0.87,
    precision: 0.84,
    recall: 0.89,
    f1Score: 0.86,
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <CardContent>
                <div className="h-64 bg-gradient-to-br from-blue-50 to-purple-50 rounded-lg flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="text-gray-500">Interactive volcano plot</p>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Top 50 differentially expressed genes</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="h-64 bg-gradient-to-br from-green-50 to-blue-50 rounded-lg flex items-center justify-center">
                  <div className="text-center">
                    <Box className="w-12 h-12 text-gray-400 mx-auto mb-2" />
                    <p className="text-gray-500">Expression heatmap</p>
                    <p className="text-sm text-gray-400">Connect backend to view</p>
                  </div>
                </div>
              </CardContent>
